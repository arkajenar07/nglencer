...
<body>
    ...
    <button style="margin-left: 403px;" ><a onclick="if (confirm('You sure to Logout?')){document.getElementById('logout-form').submit();}else{ window.location.href = '/dashboard' };">Logout</a></button>
    ...
    <div class="mob flex" style="">
        ...
        <ul class="mob-ul" id="nav">
            ...
            <li><a href="#des" class="links">Destionation</a></li>
            <li><a href="{{ url('/about') }}" class="links">About Us & Service</a></li>
            <button style="margin-top: 32px"><a href="if (confirm('You sure to Logout?')){document.getElementById('logout-form').submit();}else{ window.location.href = '/dashboard' };">Logout</a></button>
        </ul>
        ...
        <div class="search-box flex justify-center items-center">
            <div class="search-location">
                ...
                <div class="input-location flex items-center">
                    <input type="text" name="src-location" placeholder="Location" id="">
            ...
            <div class="search-category">
                ...
                <div class="input-category">
                    <input type="text" name="src-category" placeholder="Category" id="">
                </div>
            </div>
            <div class="search-destination">
                <h3>Select Your Destination</h3>
                <div class="input-destination">
                    <input type="text" name="src-destination" id="" placeholder="Enter Keyword" autocomplete="off">
                </div>
            </div>
        </div>
    ...
    <div class="content-container">
        ...
        <div class="grid card-contain" style="" >
            ...
            @else
                <div class="no-post" >
                    <h2 style="">No Destinations found</h2>
                </div>
            @endif
        </div>
    </div>
